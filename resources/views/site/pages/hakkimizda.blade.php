...
<style>
  .home {
      width: 100%;
      height: 70vh;
      background-image: url({{ asset('assets/img/hakkimizda/hakkimizda-header.png') }});
...
<div class="home d-flex justify-content-center align-items-center">
  ...
  <div class="content">
      <h2 class="header" style="font-size: 4rem;">HAKKIMIZDA</h2>
...
<div class="container" style="margin-top: 5rem;">
    <div class="row">
        <div class="col-md-6">
            ...
            <h4 class="card-title-1">Yarım asrı aşkın süredir Anadolu’nun önde gelen kuruluşlarından biri olan, Büyük Özaslanlar Tarım Gıda Un Yem Sanayi A.Ş. fabrikasından edinmiş olduğu tecrübe ile 2011 yılında Kayseri Boğazlıyan’ da kurulan;</h4>
            <p class="card-text">Kendine ait 10.000 m2 kapalı alanda nohut, fasulye, mercimek, ay çekirdeği ve kabak çekirdeği Eleme-Paketleme tesisine sahip Ukab Agro, kuruluştan bugüne giderek genişlemekte ve kendi markasıyla sunduğu ürün yelpazesi ile tarım sektörüne her geçen gün yenilik katmaya devam etmektedir.</p>
            <p class="card-text">2014 yılında Rusya ve Ukrayna’dan tarım ürünleri ithalatına başlayarak dış ticarete giriş yapan Ukab Agro, başlamasından itibaren ithal etmiş olduğu ürünleri Türkiye’deki lokal pazarın yanı sıra, Doğu - Batı Afrika bölgelerine ulaştırmaya devam etmiştir.</p>
            <p class="card-text">Şirkette yapılan yenilik çalışmalarının ardından Kayseri’de “Merkez Dış Ticaret Ofisi” kurarak dünyanın tüm diğer ülkelerine, çeşitli tarım ürünlerinin satış ve pazarlamasını yapmak; bu sayede ülkemize katma değer sağlamak için, profesyonel ekibi ile birlikte ilkeli, dürüst ve güvenilir hizmet vermekten gurur duymaktadır.</p>
        </div>
        <div class="col-md-6">
            <img src="{{ asset('assets/img/hakkimizda/logo 2-2 2.png') }}" class="card-img-top">
        </div>
    </div>
</div>
